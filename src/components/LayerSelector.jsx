...
export default function InfoPanel({raster, setRaster, topo, setTopo, cityTrees, setCityTrees, aIndex, setAIndex}) {
      ...
      >
        ...
        >
          ...
          <button
                      ...
                      <button
                        type='button'
                        onClick={() => {setCityTrees(!cityTrees)}}
                        className={classNames(
                            cityTrees
                              ? "bg-dark-wood-800"
                              : "bg-dark-wood-400",
